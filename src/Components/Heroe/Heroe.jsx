      ...
      <div className={heroStyles.container} id='heroe' >
          <div className={heroStyles.overlay}>
             <div className={` md:w-[85%] h-[90%] lg:h-[60%] md:h-[80%] xl:h-[37%] mx-auto text-white flex flex-col items-center justify-between text-center ${heroStyles.contTexts}`}>
              ...
              <div className={` ${heroStyles.btn} bg-[#9BE150] flex items-center justify-center w-[30%] xl:w-[15%] rounded-[3.4vw] xl:text-[1.1vw] md:text-[2.1vw] text-[12px] py-[1.5%] hover:bg-[transparent] hover:border-[#9BE150] hover:border-2`}> Get Started </div> 
             </div>
          </div>
      </div>
    )
