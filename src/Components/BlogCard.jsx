  ...
  return (
    <div className='lg:w-[30%] mt-4 h-[60%]' style={{boxShadow:'0px 16px 40px rgba(117, 142, 254, 0.25)'}}>
        ...
        <div className='p-[8%] lg:p-[5%] xl:p-[8%] flex flex-col justify-between  h-[50%]'>
            ...
            <button className='mt-[7%] bg-[#9BE150] w-[60%] md:w-[50%]  lg:w-[63%]  mx-auto rounded-full text-OpenSans text-[20px] md:text-[24px] lg:text-[14px] xl:text-[20px] font-[700] leading-[54px] text-white'>Read More</button>
        </div>
    </div>
  )
}
