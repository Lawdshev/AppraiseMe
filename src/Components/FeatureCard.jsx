...
function FeatureCard({head, text,img}) {
  return (
    <div className={`${indexStyles.featureCard} w-[70%] h-[350px] md:h-[404px] md:w-[282px] xl:w-[20%] xl:h-[400px] 2xl:h-[550px] 4xl:h-[600px] 5xl:h-[800px] my-5 lg:my-0 mx-auto md:mx-0 flex pt-[2%] items-center flex-col justify-around px-[0.5%]`}>
