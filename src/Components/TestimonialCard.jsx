...
function TestimonialCard({img, name, testimonial}) {
  return (
    <div className={`w-[282px] h-[400px] hover:bg-[#9BE150] 2xl:w-[20%] 2xl:h-[80%] bg-[#FFFFFF] flex flex-col relative xl:justify-between px-[1%] mt-[20%] lg:mt-[7%] xl:mt-[2%] 3xl:h-[550px]`} style={{boxShadow: '0px 16px 40px rgba(117, 142, 254, 0.25)'}}>
