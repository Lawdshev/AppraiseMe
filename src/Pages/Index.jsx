...
function Index() {
  return (
    <div>
      {/* Get on Board */}
      <div className='h-[186px] bg-[#9BE150] flex items-center'>
        <div className='lg:w-[90%] xl:w-[80%] w-full h-[50%] md:h-[70%] lg:h-[90%] text-[#ffffff] justify-between font-openSans font-bold lg:text-[24px] lg:leading-[51px] md:text-[20px] md:leading-[40px] text-[10px] leading-[20px] mx-auto flex flex-col text-center'>
          <p>AppraiseMe aids objectivity in Employee Appraisals, Promotes and Rewards</p>
          <p>Systems.</p>
          <p>Get Onboard NOW!</p>
        </div>
      </div>
      ...
      {/* Our features */}
    <div className=' bg-[#ffffff] lg:h-[100vh] flex items-center mb-[10%] md:mb-[5%] lg:mb-[0%]'>
        <div className='h-[90%] w-full mt-[10%] lg:mt-[0%] flex flex-col justify-around500'>
          <div className='text-center text-[#464545] font-openSans'>
              <h1 className='font-extrabold text-[20px] leading-[36px] md:text-[28px] md:leading-[40px] lg:text-[32px] lg:leading-[54px]'>Our Features</h1>
              <p className='text-[12px] leading-[30px] md:text-[16px] md:leading-[40px] lg:leading-[51px] font-bold lg:text-[20px]' >Explore some of our exciting features here</p>
          </div>
          <div className='flex py-8 lg:py-0 flex-col lg:mt-[10%] xl:mt-[3%] md:flex-row md:flex-wrap lg:h-[90%] xl:h-[70%] justify-around w-full'>
            {
      ...
      <div className={`${indexStyles.missionDiv} lg:h-[100vh] flex items-center justify-center`}>
          <div className='w-[90%] xl:h-[80%] lg:h-[85%] flex justify-between mb-[10%] lg:mb-0 flex-col-reverse xl:flex-row px-1 py-8 lg:py-0'>
              ...
              <div className='xl:w-[48%] xl:mt-[10%] font-openSans'>
                  <div className='h-[28%]'>
                      <h1 className='text-[#464545] font-bold text-[22px] leading-[32px] md:text-[28px] md:leading-[40px] lg:text-[32px] text-center xl:text-start lg:leading-[54px] xl:ml-[10%]'>Know About Our Mission</h1>
                      <p className='text-[#1A1919A6] text-[13px] leading-[20px] md:text-[16px] md:leading-[25px] lg:text-[20px] lg:leading-[30px] text-center xl:w-[90%]'> <span className='text-[#9BE150]'> AppraiseMe </span> is a flexible and insightful <br /> platform</p>
                  </div>
                  <div className={`${indexStyles.missionComments} mt-[2%] xl:mt-0 h-[72%] w-full pt-[5%] pb-[5%] flex flex-col justify-between`}>
                      <p className='w-4/5 text-center mx-auto text-[12px] leading-[200%] md:text-[15px] h-[80%] md:leading-[290%]'>Our approach to performance appraisal is simple: leverage your employees’ skills while rewarding performance. AppraiseMe is a flexible and insightful platform that will help you grow your people so you can grow your business.</p>
       ...
       <div className={` mb-[5%] flex flex-col ${indexStyles.testimonial} `}>
        <h2 className='font-openSans text-[36px] font-[800] leading-[54px] mt-[5%] text-center'>Testimonials</h2>
        <p className='px-3 mt-[1.5%] font-openSans font-[700] text-[24px] leading-[31px] text-center text-[#1a1919A6] '>See what some of our users are saying <br className='hidden md:block' /> about us</p>
      ...
      {/* business */}
      <div className='h-[60vh] bg-[#9BE150] flex flex-col xl:flex-row'>
        <div className='xl:w-[50%] h-full flex items-center justify-center '>
      ...
      {/* blog */}
       <div className=' flex flex-col items-center justify-around mt-8'>
            <div className='flex flex-col items-center justify-center '>
                <h3 className='text-[36px] font-[800] font-OpenSans leading-[54px] text-[#1A1919]'>Blog</h3>
                <h2 className='text-[20px] md:text-[24px] font-[700] font-OpenSans leading-[31px]'>Some of the latest news on our blog </h2>
            </div>
